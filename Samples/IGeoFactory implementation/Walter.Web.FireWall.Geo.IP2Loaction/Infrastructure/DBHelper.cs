// ***********************************************************************
// Assembly         : Walter.Web.FireWall.Geo.IP2Loaction
...
// ***********************************************************************
// <copyright file="DBHelper.cs" company="Walter.Web.FireWall.Geo.IP2Loaction">
//     Copyright (c) Computer Aided Trading Systems SA. All rights reserved.
// </copyright>
// <summary>
// The DBHelper is used to make sure that the database exists. 
// In production you are not likely to use this method as the database will 
// normally need to be created using a dashboard or ticket system
//</summary>
// ***********************************************************************
